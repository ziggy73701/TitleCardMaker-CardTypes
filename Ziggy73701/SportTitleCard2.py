...
OverrideStyle = Literal['', 'raw', 'smackdown', 'aew']

class SportTitleCard2(BaseCardType):
    """
    This class describes a CardType designed by Ziggy. This card type
    is wrestling, and features either a aew/wwe overlay.
    """

    """Directory where all reference files used by this card are stored"""
    REF_DIRECTORY = BaseCardType.BASE_REF_DIRECTORY / 'sport2'
    ...
    TITLE_FONT = str((REF_DIRECTORY / 'WWE Raw.ttf').resolve())
    DEFAULT_FONT_CASE = 'upper'
    TITLE_COLOR = 'rgb(215, 23, 22)'
    FONT_REPLACEMENTS = {}
    ...
    SEASON_COUNT_FONT = REF_DIRECTORY / 'WWE Raw.ttf'
    EPISODE_COUNT_FONT = REF_DIRECTORY / 'WWE Raw.ttf'
...
#            f'{colorspace}',
    ...
    def is_custom_font(font: 'Font') -> bool:
        ...
        return ((font.color != SportTitleCard2.TITLE_COLOR)
            or (font.file != SportTitleCard2.TITLE_FONT)
