...
class SportTitleCard(BaseCardType):
    """
    ...
    REF_DIRECTORY = BaseCardType.BASE_REF_DIRECTORY / 'sport'
    ...
    EPISODE_TEXT_FONT = REF_DIRECTORY / 'WWE Raw.ttf'
    EPISODE_TEXT_COLOR = 'rgb(255, 255, 255)'
    ...
    def text_commands(self) -> ImageMagickCommands:
        ...
        vertical_shift = 550 + self.font_vertical_shift
        title_only_command = [
    ...
    def is_custom_font(font: 'Font') -> bool: # type: ignore
        ...
        return ((font.color != SportTitleCard.TITLE_COLOR)
            or (font.file != SportTitleCard.TITLE_FONT)
            or (font.kerning != 1.0)
    ...
    def is_custom_season_titles(
        ...
        standard_etf = SportTitleCard.EPISODE_TEXT_FORMAT.upper()
